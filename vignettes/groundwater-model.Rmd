...
library(ggforce)
library(patchwork)
source("../proc/proc_nitrates_gw_model.R")
# getwd()
```
...
xsection_df <- tibble(density = set_units(seq(0.5,3,by=0.5), "1/acre"),

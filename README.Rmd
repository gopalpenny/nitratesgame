...
<!-- badges: start -->
[![Travis build status](https://travis-ci.com/gopalpenny/nitratesgame.svg?branch=master)](https://travis-ci.com/gopalpenny/nitratesgame)
[![Codecov test coverage](https://codecov.io/gh/gopalpenny/nitratesgame/branch/master/graph/badge.svg)](https://codecov.io/gh/gopalpenny/nitratesgame?branch=master)
<!-- badges: end -->
